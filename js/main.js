...
let libroEncontrado = null;  // Guardará el objeto del libro si existe en el array
...
dialogBtnAceptar.addEventListener('click', () => {
  dialogInformativo.close();
});
...
const procesarEnvio = (e) => {
  ...
  // Decide que accion ejecutar segun el boton del menu elegido antes.
